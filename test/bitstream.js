import {Stream, Bitstream, UnderflowError} from '../';
import assert from 'assert';

describe('bitstream', function() {
  let makeBitstream = function(bytes) {
    bytes = new Uint8Array(bytes);
    let stream = Stream.fromBuffer(bytes);
    return new Bitstream(stream);
  };
    
  it('copy', function() {
    let bitstream = makeBitstream([10, 160], [20, 29, 119]);
  ...
  it('advance', function() {
    ...
    assert.throws(() => bitstream.advance(40), UnderflowError);
  });
  ...
  it('rewind', function() {
    ...
    assert.throws(() => bitstream.rewind(10), UnderflowError);
  });
  ...
  it('seek', function() {
    ...
    assert.throws(() => bitstream.seek(100), UnderflowError);
    assert.throws(() => bitstream.seek(-10), UnderflowError);
  });
  ...
  it('read/peek unsigned', function() {
